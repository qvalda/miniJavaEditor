...
class ClassDeclarationNode(
    override val name: String, val baseName: String?, val variables: List<VarDeclarationNode>, val methods: List<MethodDeclarationNode>,
    override val location: NodeLocation
) : INodeWithLocation, IVisitableNode {
    override fun accept(v: IProgramVisitor) {
        v.visit(this)
    }
}
...
class MethodDeclarationNode(
    override val name: String, val type: TypeNode, val arguments: List<FormalListNode>, val variables: List<VarDeclarationNode>,
    val statements: List<StatementNode>, val returnExp: ExpressionNode, override val location: NodeLocation
) : INodeWithLocation, IVisitableNode {
    override fun accept(v: IProgramVisitor) {
        v.visit(this)
    }
...
class LiteralStringExpressionNode(val value: String?) : ExpressionNode()
class LiteralNumberExpressionNode(val value: String?) : ExpressionNode()
class LiteralCharExpressionNode(val value: String?) : ExpressionNode()
